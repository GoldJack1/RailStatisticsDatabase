...
export default function AddOperator() {
  ...
  function validateForm() {
    ...
    if (!formData.operatorregion.trim()) {
      newErrors.operatorregion = 'Operator region is required';
    }
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (formData.colorHex.trim()) {
        operatorData.colorHex = formData.colorHex.trim().toUpperCase();
      }

      await addDoc(collection(db, 'toc_operators'), operatorData);
      
      toast.success('Train operator added successfully!');
      navigate('/operators');
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              ...
              <Nav.Link onClick={() => navigate('/add-operator')} className="active">Add Operator</Nav.Link>
      ...
      <Container>
        <Row className="justify-content-center">
          <Col lg={8}>
            <Card>
              <Card.Header>
                <h3 className="mb-0">🚄 Add New Train Operator</h3>
              </Card.Header>
              <Card.Body>
                <Form onSubmit={handleSubmit}>
                  ...
                  <Alert variant="info">
                    ...
                    The operator will be added to the database and can be edited later.
                  </Alert>
